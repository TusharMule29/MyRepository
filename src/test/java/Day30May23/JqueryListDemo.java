...
public class JqueryListDemo {
	public static void main(String[] args) throws InterruptedException {
		...
		List<WebElement> listofWebElement=   driver.findElements(By.xpath("(//div[@class='comboTreeDropDownContainer']//ul//li)[3]"));

		
	WebElement gettxt = driver.findElement(By.xpath("(//div[@class='comboTreeWrapper'])[1]//span[@class='comboTreeItemTitle']"));
